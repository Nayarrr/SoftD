public class TrieurThreads extends Thread {

  private int[] t; // tableau � trier
  private int debut, fin; // tranche de ce tableau qu'il faut trier

  public TrieurThreads(int [] t, int debut, int fin){
    this.t=t;
    this.debut = debut;
    this.fin = fin;
  }

  public TrieurThreads(int [] t){
    this.t = t;
    this.debut = 0;
    this.fin = t.length - 1;
  }
  ...
  public void run() {
    if (fin - debut < 2) {
        ...
        TrieurThreads trieur1 = new TrieurThreads(t, debut, milieu);
        TrieurThreads trieur2 = new TrieurThreads(t, milieu + 1, fin);
  ...
  public static void main(String[] args) {
    ...
    TrieurThreads trieur = new TrieurThreads(t);
    trieur.start();
